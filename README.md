...
- [DoScript](https://github.com/TheServer-lab/DoScript) - Automation language with English-like syntax for file operations and system tasks. Features visual workflow builder and text-based scripting. `Custom` `Python`
